    ...
    return (
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-700 mb-6 max-w-md">
              {`We're on a mission to make healthy eating convenient, delicious, and accessible for everyone. Our
              chef-prepared meals are crafted with premium ingredients to nourish your body and delight your taste buds.`}
            </p>
            <div className="flex space-x-4">
              <Link
                href="#"
                className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-700 hover:bg-primary hover:text-white transition-colors duration-200"
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-700">info@frescura.com</span>
              </li>
            </ul>
            {/* <div className="mt-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-2">We Accept</h4>
              <div className="flex space-x-3">
                <div className="w-10 h-6 flex items-center justify-center text-gray-700">
        ...
        <div className="pt-8 border-t border-gray-100 text-center">
          <p className="text-gray-600 text-sm">&copy; {currentYear} Frescura. All rights reserved. Designed with ♥ for healthy living.</p>
        </div>
      </div>
    );
  }
